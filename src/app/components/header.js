    ...
    <>
      <header className="relative shadow-2xl" style={{ backgroundColor: '#55b7b6' }}>
        ...
        <div className="relative z-10">
          ...
          <div className="grid grid-cols-3 items-center px-4 sm:px-6 lg:px-8 xl:px-12 py-4 lg:py-6 gap-4">
            
            {/* Logo y marca - columna izquierda */}
            <div className="flex items-center group justify-self-start">
            ...
            {/* Navegación central - columna central - mejor adaptación */}
            <nav className="hidden lg:block justify-self-center w-full">
            ...
            {/* Controles de la derecha - columna derecha */}
            <div className="flex items-center gap-2 sm:gap-3 justify-self-end">
              ...
              >
                <div className="w-8 h-8 sm:w-10 sm:h-10 lg:w-12 lg:h-12 bg-gradient-to-r from-orange-400 to-red-500 rounded-full flex items-center justify-center shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-110 hover:rotate-3">
                ...
                {/* Badge del contador */}
                {getTotalItems() > 0 && (
                  <div className="absolute -top-1 -right-1 sm:-top-2 sm:-right-2 w-4 h-4 sm:w-5 sm:h-5 bg-yellow-400 text-red-600 text-xs font-bold rounded-full flex items-center justify-center shadow-lg animate-bounce">
                    {getTotalItems()}
                  </div>
                )}
