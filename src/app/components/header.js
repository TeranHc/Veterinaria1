...
<header className="relative shadow-2xl" style={{ backgroundColor: '#55b7b6' }}>
        ...
        <div className="relative z-10">
          {/* Todo en una sola línea con más padding vertical */}
          <div className="flex items-center justify-between px-6 lg:px-12 py-6">
            ...
            <div className="flex items-center group flex-shrink-0">
              <div className="relative">
                <div className="w-12 h-12 lg:w-16 lg:h-16 bg-white rounded-full shadow-lg flex items-center justify-center group-hover:shadow-xl transition-all duration-300 transform group-hover:scale-105">
                  <img 
                    src="/images/1.png" 
                    alt="SaludPet Logo" 
              ...
              <div className="ml-3">
                <h1 className="text-white font-bold text-2xl lg:text-4xl tracking-wide drop-shadow-lg">
                  Salud<span className="text-yellow-300">Pet</span>
                </h1>
                <p className="text-black text-opacity-70 text-sm lg:text-base font-medium leading-tight">
                  Cuidado veterinario de calidad
                </p>
              </div>
            </div>

            {/* Navegación central - solo desktop - ahora perfectamente centrada */}
            <nav className="hidden lg:block absolute left-1/2 transform -translate-x-[48%]">
                ...
                <div className="flex items-center gap-6">
                  {menuItems.map((item, index) => (
                    <div key={item.href} className="flex items-center">
                      <Link 
                        href={item.href} 
                        className="flex items-center gap-2 text-black hover:text-yellow-300 transition-all duration-300 font-medium text-base lg:text-lg group"
                      >
            ...
            <div className="flex items-center gap-3 flex-shrink-0">
              ...
              >
                <div className="w-10 h-10 lg:w-12 lg:h-12 bg-gradient-to-r from-orange-400 to-red-500 rounded-full flex items-center justify-center shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-110 hover:rotate-3">
              ...
              >
                <div className="w-6 h-6 bg-white/20 backdrop-blur-sm rounded-lg flex flex-col items-center justify-center space-y-1 group-hover:bg-white/30 transition-all duration-300">
                  <span className={`block w-4 h-0.5 bg-white transition-all duration-300 ${isMenuOpen ? 'rotate-45 translate-y-1' : ''}`}></span>
                  <span className={`block w-4 h-0.5 bg-white transition-all duration-300 ${isMenuOpen ? 'opacity-0' : ''}`}></span>
                  <span className={`block w-4 h-0.5 bg-white transition-all duration-300 ${isMenuOpen ? '-rotate-45 -translate-y-1' : ''}`}></span>
                </div>
              </button>
            </div>
        ...
        {/* Ondas decorativas en la parte inferior - ahora pegadas al borde inferior */}
