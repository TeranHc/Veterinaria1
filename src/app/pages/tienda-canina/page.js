    ...
    <div className="min-h-screen  py-8 px-4">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="relative mb-2">
          ...
          {/* Botón del carrito posicionado a la derecha */}
          <button
            onClick={() => setShowCart(true)}
            className="absolute right-0 top-1/2 -translate-y-1/2 bg-blue-600 hover:bg-blue-700 text-white p-3 rounded-full transition-colors duration-200"
          >
